...
const UpdateCartListService = async (req) => {
    try {
        ...
        let reqBody=req.body;
        await CartModel.updateOne({_id:cartID,userID:user_id},{$set:reqBody}); // Match and update 
...
const CartListService = async (req) => {
    try {
        ...
        let JoinStageBrand={$lookup:{from:"brands",localField:"product.brandID",foreignField:"_id",as:"brand"}}; // CartListService ata optional 
