...
const ProductList = () => {
    ...
    const inputOnChange=async (name,value)=>{
        SetFilter((data)=>({
            ...data,
            [name]:value    // je Name er value change hove tar name.
        }))
    }
    ...
    useEffect(() => {
        (async ()=>{
            ...
            !isEveryFilterPropertyEmpty?await ListByFilterRequest(Filter):null;  // Filter object jodi faka hoi ListByFilterRequest Call hove na . 
                                                    ...
                                                    return(
                                                        ...
                                                        <div key={i} className="col-md-3 p-2 col-lg-3 col-sm-6 col-12">
                                                            <Link to={`/details/${item['_id']}`} className="card shadow-sm h-100 rounded-3 bg-white">
                                                                <div className="product-img product-list-img">
