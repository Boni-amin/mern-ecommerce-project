...
const AppNavBar = () => {
    ...
    const onLogout=async ()=>{
        ...
        sessionStorage.clear(); // Jodi sessionStorage take thale clear hobe
        localStorage.clear(); // Jodi localStorage take thale clear hobe
        navigate("/");
    };
    ...
    return (
        <>
                        ...
                        <div className="col-md-6">
                            <span>
                                ...
                                <span className="f-12 mx-2">
                                    <i className="bi bi-envelope"></i> 01317860472
                                </span>
                            </span>
                        </div>
                        <div className="col-md-6">
            ...
            <nav className="navbar  sticky-top bg-white navbar-expand-lg navbar-light py-3 border">
                <div className="container">
...

                        {
                            isLogin()?(
                                ...
                                <>
                                    ...
                                    <UserSubmitButton onClick={onLogout} textProceing="Logout.." text="Logout" className="btn ms-3 btn-success d-flex"/>
