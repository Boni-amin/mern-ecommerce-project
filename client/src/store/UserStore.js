...
isLogin:()=>{
    ...
    UserOTPRequest:async(email)=>{
        ...
        setEmail(email); // sessionStorage a email Set .
        set({isFormSubmit:false})
        return res.data['status'] === "success"; // Akhane return korbe true or false .
    },
    ...
    VerifyLoginRequest:async(otp)=>{
        set({isFormSubmit:true})
        let email= getEmail(); // sessionStorage theke Email get 
